...
- **🔗 Join Link Invitations**: Users can now join groups via a shareable, PWA-aware link with automatic login and join request handling.
- **🎨 UI Polish**: Refined "Groups" dialog spacing, modernized management icons, and added descriptive sharing text for invitations.
